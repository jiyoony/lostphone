        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="phonemanagements"
                        to="/phonemanagements/phonemanagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="rentalPhones"
                        to="/tempphonemanagements/rentalPhones"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'Lossmanagement', 
                description: 'Lossmanagement을 관리하는 화면입니다.', 
                key: 'lossmanagements', 
                route: '/lostphones/lossmanagements',
                ImageUrl: '',
            },
            { 
                title: 'Phonemanagement', 
                description: 'phonemanagement을 관리하는 화면입니다.', 
                key: 'phonemanagements', 
                route: '/phonemanagements/phonemanagements',
                ImageUrl: '',
            },
            { 
                title: 'RentalPhone', 
                description: 'rental-phone을 관리하는 화면입니다.', 
                key: 'rentalPhones', 
                route: '/tempphonemanagements/rentalPhones',
                ImageUrl: '',
            },
